    ...
    */}
      ...
      */}
        ...
        <h1 className="text-3xl font-bold text-center mb-6 pb-3 relative">
          ...
          <div className="absolute bottom-0 left-1/4 right-1/4 h-1 bg-gradient-to-r from-blue-500 via-cyan-400 via-green-400 via-yellow-400 via-orange-400 to-red-500" />
        </h1>
